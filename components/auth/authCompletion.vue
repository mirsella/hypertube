    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form @submit.prevent="register" class="space-y-6">
                <div>
                    <label for="username" class="block text-sm font-medium leading-6 text-gray-900 text-white">
                ...
                <div>
                    <label for="lastname" class="block text-sm font-medium leading-6 text-gray-900 text-white">
